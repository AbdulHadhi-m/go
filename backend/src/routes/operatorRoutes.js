...
import {
  ...
  updateBus,
  deleteBus,
} from "../controllers/operator/busOperatorController.js";
...
import {
  ...
  cancelTrip,
  addTripOffer,
} from "../controllers/operator/tripOperatorController.js";

import { getOperatorBookings } from "../controllers/operator/bookingOperatorController.js";

import { getRevenueSummary } from "../controllers/operator/revenueOperatorController.js";

import { getPassengerListByTrip } from "../controllers/operator/passengerOperatorController.js";

import { getRoutePerformance } from "../controllers/operator/analyticsOperatorController.js";
