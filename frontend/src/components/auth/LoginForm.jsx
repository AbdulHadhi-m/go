    ...
    <div className="mx-auto max-w-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          className="w-full rounded-2xl border border-violet-100 px-4 py-3"
        />
        ...
        <button
          disabled={loading}
          className="w-full rounded-2xl bg-violet-700 py-3 text-white hover:bg-violet-800 disabled:opacity-60"
        >
      ...
      <p className="mt-6 text-center text-sm text-slate-500">
        ...
        <Link to="/register" className="text-violet-700 font-semibold">
          Create account
        </Link>
      </p>
    </div>
