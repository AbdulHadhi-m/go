  ...
  return (
    <MainLayout>
      <section className="mx-auto flex min-h-[70vh] max-w-4xl flex-col items-center justify-center px-4 text-center">
        <div className="rounded-full bg-red-100 px-5 py-2 text-sm font-semibold text-red-700">404 Error</div>
        ...
        <Link to="/" className="mt-8 rounded-2xl bg-red-700 px-6 py-3 font-semibold text-white">
          Back to Home
        </Link>
      </section>
    </MainLayout>
